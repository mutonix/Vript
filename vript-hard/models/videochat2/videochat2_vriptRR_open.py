...
system="Carefully watch the video and pay attention to the cause and sequence of events, the detail and movement of objects, and the action and pose of persons. Based on your observations, give the answer that accurately addresses the question.\n"
question_prompt=""
answer_prompt=""
return_prompt=""
hint_prompt="\nHint:"
...
for data_sample in tqdm(vript_RR_dataset):
    ...
    rr_answer = data_sample['open_answer']

    data_item_video = {'video_path': video_path, 'question': question, 'answer': rr_answer, 'hint': hint}
    data_item_clip = {'video_path': clip_path, 'question': question, 'answer': rr_answer, 'hint': hint}
